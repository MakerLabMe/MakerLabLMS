  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved download as @download" do
        ...
        post :create, {:download => { "title" => "invalid value" }}, valid_session
        assigns(:download).should be_a_new(Download)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested download" do
        ...
        Download.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => download.to_param, :download => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the download as @download" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Download.any_instance.stub(:save).and_return(false)
        put :update, {:id => download.to_param, :download => { "title" => "invalid value" }}, valid_session
        assigns(:download).should eq(download)
      end
