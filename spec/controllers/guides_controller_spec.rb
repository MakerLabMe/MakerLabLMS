  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved guide as @guide" do
        ...
        post :create, {:guide => { "title" => "invalid value" }}, valid_session
        assigns(:guide).should be_a_new(Guide)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested guide" do
        ...
        Guide.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => guide.to_param, :guide => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the guide as @guide" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Guide.any_instance.stub(:save).and_return(false)
        put :update, {:id => guide.to_param, :guide => { "title" => "invalid value" }}, valid_session
        assigns(:guide).should eq(guide)
      end
